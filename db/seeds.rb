...
TagList.create!(
  [
    {post_id: posts[46][:id], tag_id: tags[0][:id]},
    {post_id: posts[46][:id], tag_id: tags[3][:id]},
    {post_id: posts[45][:id], tag_id: tags[0][:id]},
    {post_id: posts[45][:id], tag_id: tags[2][:id]},
    {post_id: posts[44][:id], tag_id: tags[0][:id]},
    {post_id: posts[44][:id], tag_id: tags[4][:id]},
    {post_id: posts[43][:id], tag_id: tags[0][:id]},
    {post_id: posts[43][:id], tag_id: tags[5][:id]},
    {post_id: posts[42][:id], tag_id: tags[0][:id]},
    {post_id: posts[42][:id], tag_id: tags[1][:id]},
    {post_id: posts[41][:id], tag_id: tags[3][:id]},
    {post_id: posts[41][:id], tag_id: tags[4][:id]},
    {post_id: posts[40][:id], tag_id: tags[0][:id]},
    {post_id: posts[40][:id], tag_id: tags[3][:id]},
    {post_id: posts[39][:id], tag_id: tags[1][:id]},
    {post_id: posts[39][:id], tag_id: tags[3][:id]},
    {post_id: posts[38][:id], tag_id: tags[1][:id]},
    {post_id: posts[38][:id], tag_id: tags[2][:id]},
    {post_id: posts[37][:id], tag_id: tags[2][:id]},
    {post_id: posts[37][:id], tag_id: tags[3][:id]},
    {post_id: posts[36][:id], tag_id: tags[3][:id]},
    {post_id: posts[36][:id], tag_id: tags[4][:id]},
    {post_id: posts[35][:id], tag_id: tags[5][:id]},
    {post_id: posts[34][:id], tag_id: tags[0][:id]},
    {post_id: posts[33][:id], tag_id: tags[1][:id]},
    {post_id: posts[32][:id], tag_id: tags[2][:id]},
    {post_id: posts[31][:id], tag_id: tags[3][:id]},
    {post_id: posts[30][:id], tag_id: tags[4][:id]},
    {post_id: posts[29][:id], tag_id: tags[5][:id]},
    {post_id: posts[28][:id], tag_id: tags[0][:id]},
    {post_id: posts[27][:id], tag_id: tags[1][:id]},
    {post_id: posts[26][:id], tag_id: tags[2][:id]},
    {post_id: posts[25][:id], tag_id: tags[3][:id]},
    {post_id: posts[24][:id], tag_id: tags[4][:id]},
    {post_id: posts[23][:id], tag_id: tags[5][:id]},
    {post_id: posts[22][:id], tag_id: tags[0][:id]},
    {post_id: posts[21][:id], tag_id: tags[1][:id]},
    {post_id: posts[19][:id], tag_id: tags[2][:id]},
    {post_id: posts[18][:id], tag_id: tags[3][:id]},
    {post_id: posts[17][:id], tag_id: tags[4][:id]},
    {post_id: posts[16][:id], tag_id: tags[5][:id]},
    {post_id: posts[15][:id], tag_id: tags[0][:id]},
    {post_id: posts[14][:id], tag_id: tags[1][:id]},
    {post_id: posts[13][:id], tag_id: tags[2][:id]},
    {post_id: posts[12][:id], tag_id: tags[3][:id]},
    {post_id: posts[11][:id], tag_id: tags[4][:id]},
    {post_id: posts[10][:id], tag_id: tags[5][:id]},
